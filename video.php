...
<section class="index-intro">
    <div class="index intro-bg">
        ...
        <div class="index-intro-2">
                <h2>Video Gallery</h2>
                <br/>
                <h3>Let's Talk About Cars</h3>
            </div>
            <div class="video-container">
                <p style="margin-top: 5px">This is a video that is very sentimental to me containing footage that I filmed in the Spring of 2012 throughout my study abroad in France. The idea was to emphasize and explore the relationship between public space, public art, and the general public.
                    All public/street performers were well compensated. 
                </p></br>
